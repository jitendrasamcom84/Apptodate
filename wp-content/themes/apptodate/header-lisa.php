    ...
    <script type="text/javascript">
        ...
        $(function() {
            $(window).scroll(function() {
                ...
                var r = $(".cross_part");
                var positionr = r.position(); 

                var s = $(".get_center");
                var positions = s.position(); 
                ...
                if ($(this).scrollTop() + 120 > positionr.top && $(this).scrollTop() + 120 < position.top) {
                    $('.full_heder img').attr('src', 'http://192.64.82.125/apptodate/wp-content/uploads/2018/06/main_logo.png');
                }

                if ($(this).scrollTop() + 120 > positions.top && $(this).scrollTop() + 120 < position.top) {
                    $('.full_heder img').attr('src', 'http://192.64.82.125/apptodate/wp-content/uploads/2018/06/main_logo1.png');
                }
        ...
        <div class="full_div">
            <div class="embed-responsive embed-responsive-16by9 h100vh">
                ...
                <div class="outerli">
                    <div class="middlesp">
                        <div class="inner">
                            <p class="tit_heading">LISA</p>
                            <p class="tag_head">Compare & Save</h1>
                        </div>
                    </div>
                </div>
                <div class="full_div">
